...
export const pagesAPI = {
  ...
  deleteChoice: (pageId, choiceId) => api.delete(`/pages/${pageId}/choices/${choiceId}`),
};

// ==================== GAME ====================
export const gameAPI = {
  start: (storyMongoId) => api.post('/game/start', { storyMongoId }),
  makeChoice: (sessionId, choiceId) => api.post(`/game/session/${sessionId}/choice`, { choiceId }),
...
export const adminAPI = {
  ...
  handleReport: (reportId, status) => api.put(`/admin/reports/${reportId}`, { status }),
};
